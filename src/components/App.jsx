    ...
    render () {
        if(this.state.view === 'login'){
          return(
            ...
            return <RideShareForm usersArray={this.state.singleEventUsersArray} groupsArray={this.state.singleEventGroupArray} day_id={this.state.singleEvent.id} eventOnClick={this.eventOnClick} username={this.state.username} userId={this.state.userId} onChatClick={this.onChatButtonClick} event={this.state.singleEvent}/>
        } 
    }
}
